...
// Created: 10/30/2014 5:28:38 PM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = "dcsqmp3b4100008al9ot021su_7z2l";
    this.domain = "relatorioweb.fazenda.sp.gov.br";
    this.timezone = -3;
    this.onsitedoms = "";
    this.downloadtypes = "xls,doc,pdf,txt,csv,zip,docx,xlsx,exe";
